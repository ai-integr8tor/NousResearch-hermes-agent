...
| `FEATHERLESS_API_KEY` | Featherless API key ([featherless.ai](https://featherless.ai/)) |
| `FEATHERLESS_BASE_URL` | Override Featherless base URL (default: `https://api.featherless.ai/v1`) |
