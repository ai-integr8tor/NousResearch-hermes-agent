...
| `RUNWARE_API_KEY` | Runware API key — open + closed source LLMs on one endpoint ([runware.ai](https://runware.ai/signup)) |
| `RUNWARE_BASE_URL` | Override Runware base URL (default: `https://api.runware.ai/v1`) |
