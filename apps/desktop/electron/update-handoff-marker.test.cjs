...
/**
 * Tests for electron/update-handoff-marker.cjs — the durable handshake marker
 ...
 *
 * Run with: node --test electron/update-handoff-marker.test.cjs
 */
...
} = require('./update-handoff-marker.cjs')
