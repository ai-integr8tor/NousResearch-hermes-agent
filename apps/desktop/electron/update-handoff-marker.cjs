...
/**
 * update-handoff-marker.cjs — durable handshake for the Tauri updater hand-off.
 *
...
const HANDOFF_MARKER_MAX_AGE_MS = 30 * 60 * 1000

function handoffMarkerPath(hermesHome) {
 ...
 */
function defaultResolveSha(updateRoot) {
  try {
 ...
 */
function writeHermesUpdateHandoff(hermesHome, { sha, version, at } = {}) {
 ...
 */
function readUpdateHandoffResult(hermesHome, updateRoot, opts = {}) {
