...
export const zh: Translations = {
  ...
  cron: {
    ...
    newCron: '新建定时任务',
    emptyDescNew: '创建定时任务，按 cron 表达式执行一个提示词。Hermes 会运行它，并把结果发送到你选择的目的地。',
    emptyDescSearch: '尝试更宽泛的搜索词。',
    emptyTitleNew: '暂无定时任务',
    ...
    editTitle: '编辑定时任务',
    createTitle: '新建定时任务',
    editDesc: '更新定时任务、提示词或投递目标。更改将在下次运行时生效。',
    createDesc: '创建一个定时任务，让提示词自动运行。使用 cron 语法或类似"每 15 分钟"的自然语言。',
    nameLabel: '名称',
    ...
    optional: '可选',
    promptScheduleRequired: '提示词和定时任务为必填项。',
    saveChanges: '保存更改',
    createAction: '创建定时任务'
  },
