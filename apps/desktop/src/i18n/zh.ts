...
export const zh: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      remoteUrlDesc: '面向用户显示的远程网关公开 URL。支持路径前缀，例如 /hermes。',
      transportTitle: '传输方式',
      transportDesc: '选择 Desktop 直接连接网关，或经由本地 mTLS proxy 连接。',
      transportDirect: '直接连接',
      transportLocalMtlsProxy: '本地 mTLS proxy',
      effectiveUrlTitle: '本地 proxy URL',
      effectiveUrlDesc: 'Desktop 实际使用的高级传输端点；公开网关 URL 仍显示在设置中。',
      ...
      connectedToViaProxy: (publicUrl, effectiveUrl, version) =>
        `已连接到 ${publicUrl}，经由 ${effectiveUrl}${version ? ` · Hermes ${version}` : ''}`,
