...
function setRequest(
  ...
  metadata: Partial<Pick<ApprovalRequest, 'allowlistKey' | 'patternKey' | 'ruleKey'>> = {}
) {
  $activeSessionId.set('sess-1')
  setApprovalRequest({ allowPermanent, command, description: 'dangerous command', sessionId: 'sess-1', ...metadata })
}
