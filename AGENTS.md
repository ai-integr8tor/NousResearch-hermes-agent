...
This project is indexed by GitNexus as **hermes-agent** (142895 symbols, 261888 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
