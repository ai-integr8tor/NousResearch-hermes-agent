...
class TestReasoningOverridesDefaultConfig:
    ...
    def test_config_version_bumped(self):
        """Config version is at least 31 (where reasoning_overrides was added).

        Upstream may bump further for unrelated changes; we only assert the
        floor that our schema change introduced.
        """
        from hermes_cli.config import DEFAULT_CONFIG
