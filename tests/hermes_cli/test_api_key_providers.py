...
class TestProviderRegistry:
    ...
    def test_avian_env_vars(self):
        pconfig = PROVIDER_REGISTRY["avian"]
        assert pconfig.api_key_env_vars == ("AVIAN_API_KEY",)
        assert pconfig.base_url_env_var == "AVIAN_BASE_URL"
    ...
    def test_base_urls(self):
        ...
        assert PROVIDER_REGISTRY["avian"].inference_base_url == "https://api.avian.io/v1"
