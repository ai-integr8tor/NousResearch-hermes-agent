            ...
            for item in normalized:
                ...
                conn.execute(
                    ...
                    (
                        ...
                        raw.get("user_id"),
                        raw.get("model"),
                        self._json_text_or_none(raw.get("model_config")),
                        raw.get("system_prompt"),
                        started_at,
                        self._float_or_none(raw.get("ended_at")),
                        raw.get("end_reason"),
                        ...
                        self._int_or_default(raw.get("reasoning_tokens")),
                        raw.get("cwd"),
                        raw.get("billing_provider"),
                        raw.get("billing_base_url"),
                        raw.get("billing_mode"),
                        self._float_or_none(raw.get("estimated_cost_usd")),
                        self._float_or_none(raw.get("actual_cost_usd")),
                        raw.get("cost_status"),
                        raw.get("cost_source"),
                        raw.get("pricing_version"),
                        raw.get("title"),
                        self._int_or_default(raw.get("api_call_count")),
                        raw.get("handoff_state"),
                        raw.get("handoff_platform"),
                        raw.get("handoff_error"),
                        self._int_or_default(raw.get("rewind_count")),
                        archived,
                    ),
                )
