...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("compress", "Compress conversation context (add 'here [N]' to keep recent N turns; --preview shows what would happen; --child forces a child continuation)", "Session",
               aliases=("compact",), args_hint="[--child] [here [N] | focus topic | --preview|--dry-run]"),
    CommandDef("childcompress", "Compress context into a new child continuation session", "Session",
