...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("proactive", "Preview reusable workflow opportunities from chat history",
               "Tools & Skills", aliases=("opportunities",), args_hint="[--days N] [--source platform]",
               subcommands=("--days", "--source", "--limit", "--min-messages", "--json")),
