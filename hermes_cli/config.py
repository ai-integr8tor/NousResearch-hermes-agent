...
OPTIONAL_ENV_VARS = {
    ...
    "DISCORD_HOME_CHANNEL": {
        "description": "Discord channel ID that acts as the Hermes home / SSOT write-back target",
    ...
    "DISCORD_REQUIRE_MENTION": {
        "description": "Require @mention in Discord channels before responding (default: true)",
        "prompt": "Require @mention in Discord channels",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "DISCORD_FREE_RESPONSE_CHANNELS": {
        "description": "Comma-separated Discord channel IDs where Hermes responds without @mention",
        "prompt": "Discord free-response channel IDs (comma-separated)",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "DISCORD_AUTO_THREAD": {
        "description": "Automatically create a thread for new Discord channel messages (default: true)",
        "prompt": "Enable Discord auto-threading",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "DISCORD_IGNORE_NO_MENTION": {
        "description": "Ignore Discord messages that do not mention Hermes (legacy fallback)",
        "prompt": "Ignore Discord messages without a mention",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "DISCORD_ALLOW_BOTS": {
        "description": "How Hermes handles other bot messages in Discord: none, mentioned, or all",
        "prompt": "Discord bot-message policy (none/mentioned/all)",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "DISCORD_IGNORED_CHANNELS": {
        "description": "Comma-separated Discord channel IDs Hermes should never respond in",
        "prompt": "Discord ignored channel IDs (comma-separated)",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "DISCORD_NO_THREAD_CHANNELS": {
        "description": "Comma-separated Discord channel IDs where auto-threading is disabled",
        "prompt": "Discord no-thread channel IDs (comma-separated)",
        "url": None,
        "password": False,
        "category": "messaging",
    },
