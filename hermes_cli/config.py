...
DEFAULT_CONFIG = {
    ...
    "discord": {
        ...
        # create_category, create_channel, set_channel_topic,
        # create_project_workspace, list_roles, member_info, search_members,
        # fetch_messages, list_pins, pin_message, unpin_message, create_thread,
