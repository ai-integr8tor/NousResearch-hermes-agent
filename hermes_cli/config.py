...
_EXTRA_ENV_KEYS = frozenset({
    ...
    "MATRIX_PASSWORD", "MATRIX_ENCRYPTION", "MATRIX_E2EE_MODE", "MATRIX_DEVICE_ID", "MATRIX_HOME_ROOM",
    "MATRIX_ALLOWED_USERS", "MATRIX_ALLOWED_ROOMS", "MATRIX_IGNORE_USER_PATTERNS", "MATRIX_PROCESS_NOTICES",
    "MATRIX_REQUIRE_MENTION", "MATRIX_FREE_RESPONSE_ROOMS", "MATRIX_SESSION_SCOPE",
    "MATRIX_TOOLS_ALLOW_CROSS_ROOM", "MATRIX_TOOLS_ALLOW_CROSS_ROOM_DESTRUCTIVE",
    "MATRIX_TOOLS_ALLOW_REDACTION", "MATRIX_TOOLS_ALLOW_INVITES", "MATRIX_TOOLS_ALLOW_ROOM_CREATE",
    "MATRIX_AUTO_THREAD", "MATRIX_DM_AUTO_THREAD",
    "MATRIX_RECOVERY_KEY", "MATRIX_RECOVERY_KEY_OUTPUT_FILE",
...
OPTIONAL_ENV_VARS = {
    ...
    "MATRIX_ALLOWED_ROOMS": {
        "description": "Comma-separated Matrix room IDs allowed to trigger bot responses",
        "prompt": "Allowed Matrix room IDs (comma-separated)",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "MATRIX_IGNORE_USER_PATTERNS": {
        "description": "Comma-separated regexes for Matrix bridge/appservice ghost user IDs to ignore",
        "prompt": "Ignored Matrix user regexes (comma-separated)",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "MATRIX_PROCESS_NOTICES": {
        "description": "Process inbound Matrix m.notice events (default: false)",
        "prompt": "Process Matrix notices (true/false)",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "MATRIX_SESSION_SCOPE": {
        "description": "Matrix session scope for project rooms: auto, room, or thread (default: auto)",
        "prompt": "Matrix session scope (auto/room/thread)",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "MATRIX_TOOLS_ALLOW_CROSS_ROOM": {
        "description": "Allow Matrix tools to target explicit rooms other than the current room (default: false)",
        "prompt": "Allow Matrix cross-room tools (true/false)",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "MATRIX_TOOLS_ALLOW_CROSS_ROOM_DESTRUCTIVE": {
        "description": "Allow cross-room Matrix redaction/invite-like tools; requires MATRIX_TOOLS_ALLOW_CROSS_ROOM=true",
        "prompt": "Allow destructive Matrix cross-room tools (true/false)",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "MATRIX_TOOLS_ALLOW_REDACTION": {
        "description": "Allow Matrix message redaction tool execution (default: false)",
        "prompt": "Allow Matrix redaction tool (true/false)",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "MATRIX_TOOLS_ALLOW_INVITES": {
        "description": "Allow Matrix invite tool execution (default: false)",
        "prompt": "Allow Matrix invite tool (true/false)",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "MATRIX_TOOLS_ALLOW_ROOM_CREATE": {
        "description": "Allow Matrix room creation tool execution (default: false)",
        "prompt": "Allow Matrix room create tool (true/false)",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "MATRIX_RECOVERY_KEY_OUTPUT_FILE": {
        "description": "Optional one-time file path for a generated Matrix recovery key; created 0600 and never overwritten",
        "prompt": "Generated Matrix recovery key output file",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
