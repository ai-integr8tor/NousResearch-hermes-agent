...
OPTIONAL_ENV_VARS = {
    ...
    "ONEBOT_HTTP_URL": {
        "description": "OneBot HTTP endpoint for QQ tools (e.g. http://127.0.0.1:3000)",
        "prompt": "OneBot HTTP URL",
        "url": None,
        "tools": ["qq_send_voice"],
        "password": False,
        "category": "tool",
    ...
    "ONEBOT_WS_URL": {
        "description": "OneBot WebSocket endpoint for QQ tools (optional fallback)",
        "prompt": "OneBot WebSocket URL",
        "url": None,
        "tools": ["qq_send_voice"],
        "password": False,
        "category": "tool",
    ...
    "ONEBOT_ACCESS_TOKEN": {
        "description": "OneBot access token for QQ tools",
