...
PROVIDER_REGISTRY: Dict[str, ProviderConfig] = {
    ...
    "alibaba-token-plan-cn": ProviderConfig(
        id="alibaba-token-plan-cn",
        name="Alibaba Cloud (Token Plan, China)",
        auth_type="api_key",
        inference_base_url="https://token-plan.cn-beijing.maas.aliyuncs.com/compatible-mode/v1",
        api_key_env_vars=("ALIBABA_TOKEN_PLAN_CN_API_KEY",),
...
def resolve_provider(
    ...
    *,
    ...
    _PROVIDER_ALIASES = {
        ...
        "alibaba_token_plan_cn": "alibaba-token-plan-cn", "alibaba-token-cn": "alibaba-token-plan-cn",
        "aliyun-token-plan-cn": "alibaba-token-plan-cn", "token-plan-cn": "alibaba-token-plan-cn",
