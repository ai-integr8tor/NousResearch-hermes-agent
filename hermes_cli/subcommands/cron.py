...
def build_cron_parser(subparsers, *, cmd_cron: Callable) -> None:
    ...
    cron_create.add_argument(
        "--session",
        help="Reusable SessionDB id for this job. Runs load and append to this session instead of creating a fresh timestamped cron session each time.",
    )
    ...
    cron_edit.add_argument(
        "--session",
        help="Reusable SessionDB id for this job. Pass empty string to clear and restore fresh-session-per-run behavior.",
    )
