...
class AIAgent:
    ...
    def _capture_rate_limits(self, http_response: Any) -> None:
        ...
        Called after each API call via two paths:
        1. Streaming: ``stream.response`` exposes the httpx Response.
        2. httpx event hook: fires for EVERY response including non-streaming
           fallback (when an adapter returns a ChatCompletion instead of an
           SSE iterator).
        """
