...
LAZY_DEPS: dict[str, tuple[str, ...]] = {
    ...
    "tool.dashboard": (
        ...
        "starlette==1.3.1",  # 2026 Starlette OSV advisory cluster — keep lazy-install in sync with pyproject [web]
        "python-multipart==0.0.32",  # FastAPI UploadFile/Form; GHSA multipart parser fixes through >=0.0.31
    ),
    ...
    "tool.computer_use": (
        "mcp==1.26.0",
        "starlette==1.3.1",  # 2026 Starlette OSV advisory cluster — keep in sync with pyproject [computer-use]
    ),
}
