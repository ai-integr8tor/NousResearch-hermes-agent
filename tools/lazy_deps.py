...
LAZY_DEPS: dict[str, tuple[str, ...]] = {
    ...
    # Claude Agent SDK backend (model.claude_agent_sdk). Keep the pin in sync
    # with the `claude-agent-sdk` extra in pyproject.toml. Requires the
    # `claude` CLI on PATH at runtime (Node) in addition to this package.
    "provider.claude_agent_sdk": ("claude-agent-sdk==0.2.110",),
